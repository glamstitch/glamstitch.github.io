<script lang="ts">
	...
	import galleryMain from '$lib/assets/image/gallery.jpg?w=1920&format=webp&quality=85';
	// @ts-expect-error - vite-imagetools query parameters
	import gallery1 from '$lib/assets/image/gallery1.jpg?w=800&format=webp&quality=80';
	// @ts-expect-error - vite-imagetools query parameters
...
<svelte:head>
	...
	<meta
		name="description"
		content="Lihat portfolio karya konveksi terbaik dari Glam Stitch. Galeri lengkap hasil sablon, bordir, dan konveksi berkualitas tinggi untuk berbagai kebutuhan."
	/>
	<meta
		name="keywords"
		content="galeri konveksi, portfolio karya, hasil sablon, bordir berkualitas, konveksi terbaik"
	/>
</svelte:head>
		...
		<div class="flex flex-col items-center gap-12 lg:flex-row">
			...
			<ScrollReveal animation="fade-left" delay={400} class="lg:w-1/2">
				...
				<p class="mt-4 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
					...
					kaos polos, jaket, dan seragam custom. Area ini dirancang dengan nuansa modern dan
					pencahayaan hangat agar pelanggan merasa nyaman saat berkonsultasi maupun memilih bahan.
		...
		<div class="flex flex-col-reverse items-center gap-12 lg:flex-row">
			<ScrollReveal animation="fade-right" delay={200} class="lg:w-1/2">
				...
				<p class="mt-4 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
					...
					teknisi sablon ahli. Setiap anggota tim memiliki keahlian khusus dalam bidangnya
					masing-masing, mulai dari desain grafis, teknik jahit, hingga proses finishing. Kami
		...
		<div class="flex flex-col-reverse items-center gap-12 lg:flex-row">
			...
			<ScrollReveal animation="fade-left" delay={400} class="lg:w-1/2">
				...
				<p class="mt-4 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
					...
					aksesoris jahit. Sistem penyimpanan kami tertata rapi dengan labelisasi digital untuk
		...
		<div class="flex flex-col items-center gap-12 lg:flex-row">
			<ScrollReveal animation="fade-right" delay={200} class="lg:w-1/2">
				...
				<p class="mt-4 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
					...
					sablon, dan finishing dilakukan. Dilengkapi dengan mesin jahit industri modern dan
					peralatan sablon berkualitas tinggi, setiap produk dikerjakan oleh tenaga profesional
		...
		<div class="flex flex-col-reverse items-center gap-12 lg:flex-row">
			...
			<ScrollReveal animation="fade-left" delay={400} class="lg:w-1/2">
				...
				<p class="mt-4 text-lg leading-relaxed text-gray-600 dark:text-gray-300">
					...
					Di sini, staf kami memberikan pelayanan ramah dan cepat dalam proses pembayaran maupun
					konsultasi akhir. Selain itu, area kasir juga menjadi tempat untuk pengambilan produk jadi
