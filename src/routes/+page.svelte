...
<svelte:head>
	...
	<meta
		name="description"
		content="Glam Stitch adalah konveksi terpercaya yang menyediakan kaos, jersey, jaket, dan kemeja berkualitas tinggi. Layanan konveksi profesional dengan harga kompetitif dan hasil terbaik."
	/>

	<meta
		name="keywords"
		content="konveksi, kaos, jersey, jaket, kemeja, sablon, bordir, konveksi berkualitas"
	/>
</svelte:head>
		...
		<div class="relative mx-4 max-h-[85vh] max-w-4xl">
			...
			<div class="rounded-xl bg-white p-6 shadow-2xl dark:bg-gray-800">
				<img
					src={selectedImage}
					alt={selectedAlt}
					class="h-auto max-h-[70vh] w-full max-w-full object-contain"
				/>
			</div>
