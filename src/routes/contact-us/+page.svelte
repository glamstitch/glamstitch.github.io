...
<div class="hero-section relative isolate overflow-hidden pt-6">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-24 text-center">
        ...
        <h1 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Hubungi Tim Glam Stitch</h1>
...
<!-- Contact Us Section -->
<section class="bg-white dark:bg-gray-900 py-24 sm:py-20">
    <div class="mx-auto max-w-7xl px-6 lg:px-24">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-1 gap-16 items-center">
        ...
        <div class="space-y-8 max-w-4xl mx-auto">
          ...
          <!-- Business Hours -->
          <div class="rounded-xl p-6 shadow-md border border-orange-100 dark:border-orange-800 bg-white dark:bg-gray-800">
            <div class="text-center">
              <div class="bg-orange-500 p-3 rounded-full w-fit mx-auto mb-4">
                <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
              </div>
              <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Jam Operasional</h4>
