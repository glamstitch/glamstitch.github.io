...
<svelte:head>
	...
	<meta
		name="description"
		content="Hubungi Glam Stitch untuk konsultasi dan pemesanan konveksi. Tim customer service kami siap membantu kebutuhan konveksi Anda dengan layanan terbaik."
	/>
	<meta
		name="keywords"
		content="hubungi kami, konsultasi konveksi, customer service, pemesanan konveksi, layanan terbaik"
	/>
</svelte:head>
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		...
		<div class="mb-16 text-center">
			...
			<p class="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-300">
				Ingin bikin kaos custom, konsultasi desain, atau sekadar tanya-tanya soal produksi? Tim <span
					class="font-semibold text-indigo-600 dark:text-indigo-400">Glam Stitch</span
				> siap jadi partner terbaik untuk kebutuhan Anda.
			</p>
		</div>
			...
			>
				<div class="flex flex-col items-center gap-6 md:flex-row">
					...
					<div class="flex-1 text-center md:text-left">
						...
						<a
							href="https://wa.me/6285172202151"
							class="inline-flex transform items-center gap-3 rounded-xl bg-green-500 px-8 py-4 font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-green-600 hover:shadow-xl"
						>
			...
			>
				<div class="flex flex-col items-center gap-6 md:flex-row">
					...
					<div class="flex-1 text-center md:text-left">
						...
						>
							<p class="flex items-start gap-2 text-sm text-orange-800 dark:text-orange-300">
