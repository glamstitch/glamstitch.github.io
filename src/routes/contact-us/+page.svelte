...
<!-- Hero Section -->
<section class="hero-section relative isolate overflow-hidden bg-white dark:bg-gray-900 pt-6">
  <img loading="lazy" 
    src="https://img.freepik.com/free-photo/young-stylist-looking-through-set-shirts-fashion-shooting_1153-5249.jpg" 
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32 text-center">
      ...
      <!-- Heading -->
      <h1 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl mb-6">
        Hubungi Tim Glam Stitch
      </h1>
      
      <!-- Description -->
      <p class="mt-6 text-lg text-gray-200 sm:text-xl max-w-2xl mx-auto">
        Tim customer service Glam Stitch siap membantu Anda dengan konsultasi gratis, pemesanan, dan layanan terbaik untuk semua kebutuhan konveksi.
      </p>
    </div>
  </div>
</section>
...
<section class="bg-white dark:bg-gray-900 py-24 sm:py-32">
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="text-center mb-16">
      <h2 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl mb-6">
        Butuh Bantuan? Kami Siap Membantu!
      </h2>
      <p class="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
        Ingin bikin kaos custom, konsultasi desain, atau sekadar tanya-tanya soal produksi? Tim <span class="font-semibold text-indigo-600 dark:text-indigo-400">Glam Stitch</span> siap jadi partner terbaik untuk kebutuhan Anda.
      </p>
    </div>
    ...
    <div class="space-y-8 max-w-4xl mx-auto">
      <!-- WhatsApp -->
      <div class="rounded-2xl p-8 shadow-lg border border-green-100 dark:border-green-800 bg-white dark:bg-gray-800 hover:shadow-xl transition-all duration-300">
        <div class="flex flex-col md:flex-row items-center gap-6">
          ...
          <div class="flex-1 text-center md:text-left">
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Hubungi Kami via WhatsApp</h3>
      ...
      <!-- Business Hours -->
      <div class="rounded-2xl p-8 shadow-lg border border-orange-100 dark:border-orange-800 bg-white dark:bg-gray-800 hover:shadow-xl transition-all duration-300">
        <div class="flex flex-col md:flex-row items-center gap-6">
          <!-- Clock Icon -->
          <div class="flex-shrink-0">
            <div class="bg-orange-500 p-4 rounded-full shadow-lg">
          ...
          <!-- Content -->
          <div class="flex-1 text-center md:text-left">
            <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Jam Operasional</h3>
            <div class="text-gray-600 dark:text-gray-300 mb-4 text-lg space-y-1">
              <p>Senin - Sabtu : 08.00 - 17.00 WIB</p>
              <p>Minggu : <span class="text-red-600 dark:text-red-400 font-semibold">Tutup</span></p>
            </div>
            <!-- Info Note -->
            <div class="p-3 bg-orange-50dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
              <p class="text-sm text-orange-800 dark:text-orange-300 flex items-start gap-2">
                ...
                <span>Pesan di luar jam kerja akan dibalas pada hari kerja berikutnya</span>
              </p>
            </div>
          </div>
        </div>
