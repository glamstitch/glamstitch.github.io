		...
		<ScrollReveal animation="fade-up">
			<div class="mx-auto max-w-2xl lg:max-w-none">
				...
				<p class="mx-auto mt-8 max-w-xl text-base text-gray-600 dark:text-gray-400">
					Sebagian besar produk kami dibuat dalam jumlah terbatas. Segera pesan Kaos Polo Glam
					Stitch berkualitas premium sebelum habis!
				</p>
			</div>
		</ScrollReveal>
	</section>
					...
					<div class="space-y-8">
						...
						<div class="space-y-6">
							...
							<p class="text-base leading-relaxed text-gray-700 dark:text-gray-300">
								...
								kenyamanan maksimal sepanjang hari. Bahan berkualitas tinggi ini memiliki tekstur
								yang breathable, menyerap keringat dengan baik, dan tidak mudah kusut. Kerah polo
								klasik dengan kancing berkualitas tinggi memberikan tampilan profesional yang
								timeless. Jahitan double-stitch memastikan ketahanan dan keawetan produk untuk
				...
				<ScrollReveal animation="fade-up">
					<div class="mb-12 text-center">
						...
						<p class="mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400">
							Gunakan panduan ukuran berikut untuk memastikan Anda mendapatkan kaos polo dengan
							ukuran yang tepat dan nyaman.
						</p>
					</div>
				</ScrollReveal>
									...
									<div class="flex items-start">
										...
										<div>
											<h4 class="mb-1 text-sm font-semibold text-blue-100">
												Tips Memilih Ukuran Polo
											</h4>
											<p class="text-sm text-blue-200">
												Kaos polo memiliki potongan yang lebih fitted dibanding kaos biasa.
												Pertimbangkan untuk memilih satu ukuran lebih besar untuk kenyamanan
												optimal.
											</p>
										</div>
									</div>
