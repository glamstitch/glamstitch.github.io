...
<svelte:head>
	...
	<meta
		name="description"
		content="Pesan kaos polo berkualitas premium dari Glam Stitch. Konveksi kaos polo dengan bahan terbaik, model elegan, dan teknik sablon profesional."
	/>
	<meta
		name="keywords"
		content="kaos polo, konveksi polo, kaos polo premium, sablon polo, model polo, bahan polo"
	/>
</svelte:head>
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl py-32 text-center sm:py-48 lg:py-40">
			<div class="hidden sm:mb-8 sm:flex sm:justify-center">
				...
				>
					Koleksi kaos polo berkualitas premium dari Glam Stitch untuk tampilan yang elegan dan
					profesional.
			...
			<h1 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">
				Produk Kaos Polo Glam Stitch
			</h1>
			<p class="mt-8 text-lg font-medium text-gray-200 sm:text-xl">
				Tampil profesional dan stylish dengan kaos polo premium kami. Cocok untuk acara formal,
				kasual, hingga seragam perusahaan dengan kualitas terbaik.
			</p>
		</div>
	</div>
</div>
...
<div class="relative z-0 overflow-hidden bg-white dark:bg-gray-900">
	...
	>
		<div class="mx-auto max-w-2xl lg:max-w-none">
			...
			>
				Dapatkan Kualitas Premium untuk Kaos Polo Glam Stitch Anda
			</h2>
			<p class="mx-auto mt-8 max-w-xl text-base text-gray-600 dark:text-gray-400">
				Sebagian besar produk kami dibuat dalam jumlah terbatas. Segera pesan Kaos Polo Glam Stitch
				berkualitas premium sebelum habis!
			</p>
		</div>
	</section>
</div>
			...
			<div class="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
				<div class="lg:col-span-2">
					<div class="aspect-[4/3] w-full overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800">
						<img
							loading="lazy"
							src="https://i.pinimg.com/1200x/26/8e/fc/268efc157e9aeb9e100916cd9f987bcb.jpg"
				...
				<div class="grid grid-cols-1 gap-6">
					<div class="aspect-[4/3] w-full overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800">
						<img
							loading="lazy"
							src="https://i.pinimg.com/1200x/b9/cf/13/b9cf1394d45966487e2ab76281d9fe21.jpg"
					...
					<div class="aspect-[4/3] w-full overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800">
						<img
							loading="lazy"
							src="https://i.pinimg.com/1200x/d5/c8/bb/d5c8bb224ae8411e2fea73d085853a33.jpg"
				...
				<div class="space-y-8">
					<div>
						<h1 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">
							Kaos Polo Glam Stitch
						</h1>
						<p class="mt-4 text-lg text-gray-600 dark:text-gray-400">
							Kaos polo premium dengan desain klasik dan elegan untuk penampilan profesional
						</p>
					</div>
					...
					<div class="space-y-6">
						...
						<p class="text-base leading-relaxed text-gray-700 dark:text-gray-300">
							Kaos Polo Glam Stitch dibuat dengan bahan pique cotton premium yang memberikan
							kenyamanan maksimal sepanjang hari. Bahan berkualitas tinggi ini memiliki tekstur yang
							breathable, menyerap keringat dengan baik, dan tidak mudah kusut. Kerah polo klasik
							dengan kancing berkualitas tinggi memberikan tampilan profesional yang timeless.
							Jahitan double-stitch memastikan ketahanan dan keawetan produk untuk penggunaan jangka
							panjang.
						</p>
					</div>
					...
					<div class="space-y-4">
						...
						<div class="grid grid-cols-1 gap-4">
							...
							<div class="flex items-start space-x-3">
								...
								<p class="text-sm text-gray-700 dark:text-gray-300">
									Kerah polo dengan kancing berkualitas tinggi
								</p>
							</div>
							<div class="flex items-start space-x-3">
								<div class="flex-shrink-0">
								...
								<p class="text-sm text-gray-700 dark:text-gray-300">
									Jahitan double-stitch untuk ketahanan maksimal
								</p>
							</div>
							<div class="flex items-start space-x-3">
								<div class="flex-shrink-0">
								...
								<p class="text-sm text-gray-700 dark:text-gray-300">Pre-shrunk fabric anti-susut</p>
							</div>
						</div>
					</div>
				</div>
		...
		<section aria-labelledby="size-chart-heading" class="bg-white py-16 dark:bg-gray-900">
			<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div class="mb-12 text-center">
					...
					>
						Panduan Ukuran Kaos Polo
					</h2>
					<p class="mx-auto mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-400">
						Gunakan panduan ukuran berikut untuk memastikan Anda mendapatkan kaos polo dengan ukuran
				...
				<div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
					<div class="rounded-xl bg-gray-50 p-8 dark:bg-gray-800">
						<h3 class="mb-6 text-center text-xl font-semibold text-gray-900 dark:text-white">
							Tabel Ukuran Kaos Polo Glam Stitch
						</h3>
							...
							<table class="w-full text-sm">
								...
								<tbody class="divide-y divide-gray-200 dark:divide-gray-700">
									<tr>
										...
										<td class="px-2 py-3 text-center text-gray-700 dark:text-gray-300">44</td>
									...
									<tr>
										...
										<td class="px-2 py-3 text-center text-gray-700 dark:text-gray-300">47</td>
									...
									<tr>
										...
										<td class="px-2 py-3 text-center text-gray-700 dark:text-gray-300">50</td>
									...
									<tr>
										...
										<td class="px-2 py-3 text-center text-gray-700 dark:text-gray-300">53</td>
									...
									<tr>
										...
										<td class="px-2 py-3 text-center text-gray-700 dark:text-gray-300">59</td>
										<td class="px-2 py-3 text-center text-gray-700 dark:text-gray-300">23</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="px-2 py-3 text-center text-gray-700 dark:text-gray-300">65</td>
						...
						<div class="mt-6 rounded-lg bg-gray-800 p-4">
							<div class="flex items-start">
								...
								<div>
									<h4 class="mb-1 text-sm font-semibold text-blue-100">Tips Memilih Ukuran Polo</h4>
									<p class="text-sm text-blue-200">
										Kaos polo memiliki potongan yang lebih fitted dibanding kaos biasa.
										Pertimbangkan untuk memilih satu ukuran lebih besar untuk kenyamanan optimal.
									</p>
								</div>
							</div>
						</div>
						...
						<div class="rounded-xl bg-gray-50 p-6 dark:bg-gray-800">
							...
							<div class="space-y-4">
								<div class="flex items-start space-x-3">
									...
									<div>
										<h4 class="text-sm font-medium text-gray-900 dark:text-white">Panjang Polo</h4>
										<p class="text-sm text-gray-600 dark:text-gray-400">
											Ukur dari bahu hingga bagian bawah kaos polo
										</p>
									</div>
								</div>
								<div class="flex items-start space-x-3">
									...
									<div>
										<h4 class="text-sm font-medium text-gray-900 dark:text-white">Lebar Polo</h4>
										<p class="text-sm text-gray-600 dark:text-gray-400">
								...
								<div class="flex items-start space-x-3">
									...
									<div>
										<h4 class="text-sm font-medium text-gray-900 dark:text-white">Lengan Polo</h4>
										<p class="text-sm text-gray-600 dark:text-gray-400">
											Ukur panjang lengan dari bahu hingga ujung lengan
										</p>
									</div>
								</div>
							</div>
