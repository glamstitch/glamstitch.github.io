            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div class="flex items-start space-x-3">
                  ...
                  <p class="text-sm text-gray-700 dark:text-gray-300">Sablon atau bordir nama dan nomor</p>
                </div>
                <div class="flex items-start space-x-3">
                  <div class="flex-shrink-0">
                    <svg class="h-5 w-5 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p class="text-sm text-gray-700 dark:text-gray-300">Tahan luntur dan mudah perawatan</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              ...
              <div class="space-y-4">
                ...
                <div class="flex justify-between">
                  ...
                  <span class="text-sm text-gray-900 dark:text-white">20+ Pilihan Warna</span>
                </div>
              </div>
            </div>
