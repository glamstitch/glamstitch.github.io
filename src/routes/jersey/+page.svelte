...
<svelte:head>
	...
	<meta
		name="description"
		content="Pesan jersey olahraga berkualitas tinggi dari Glam Stitch. Konveksi jersey dengan bahan breathable, desain sporty, dan teknik sablon tahan lama."
	/>
	<meta
		name="keywords"
		content="jersey, konveksi jersey, jersey olahraga, sablon jersey, bahan breathable, desain sporty"
	/>
</svelte:head>
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl py-32 text-center sm:py-48 lg:py-40">
			<div class="hidden sm:mb-8 sm:flex sm:justify-center">
				...
				>
					Koleksi jersey olahraga berkualitas premium dari Glam Stitch untuk performa maksimal dan
					tampilan sporty.
