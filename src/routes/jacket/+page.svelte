        ...
        <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 gap-4">
                <div class="flex items-start space-x-3">
                  ...
                  <p class="text-sm text-gray-700 dark:text-gray-300">Bahan premium yang lembut dan hangat</p>
                </div>
                <div class="flex items-start space-x-3">
                  <div class="flex-shrink-0">
                    <svg class="h-5 w-5 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p class="text-sm text-gray-700 dark:text-gray-300">Desain modern dengan potongan yang pas</p>
                </div>
                <div class="flex items-start space-x-3">
                  <div class="flex-shrink-0">
                    <svg class="h-5 w-5 text-indigo-600" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div class="space-y-8">
            ...
            <div class="space-y-4">
              ...
              <a href="/product" class="w-full border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-200 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-12">
            ...
            <p class="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Gunakan panduan ukuran berikut untuk memastikan Anda mendapatkan sweater/hoodie dengan ukuran yang tepat dan nyaman untuk gaya kasual yang stylish.
            </p>
          </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-8">
                ...
                <table class="w-full text-sm">
                  ...
                  <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <tr>
                      ...
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">48</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">94</td>
                    ...
                    <tr>
                      ...
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">51</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">99</td>
                    ...
                    <tr>
                      ...
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">54</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">104</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">60</td>
                    </tr>
                    <tr>
                      ...
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">109</td>
                    ...
                    <tr>
                      ...
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">60</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">114</td>
                    ...
                    <tr>
                      ...
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">119</td>
                    ...
                    <tr>
                      ...
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">66</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">124</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">68</td>
                    </tr>
                    <tr>
                      <td class="py-3 px-2 font-medium text-gray-900 dark:text-white">XXXXL</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">82</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">69</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">129</td>
                      <td class="py-3 px-2 text-center text-gray-700 dark:text-gray-300">70</td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="mt-6 p-4 bg-blue-50dark:bg-blue-900/20 rounded-lg">
                <div class="flex items-start">
                  ...
                  <div>
                    <h4 class="text-sm font-semibold text-blue-900 dark:text-blue-100 mb-1">Tips Memilih Ukuran Sweater/Hoodie</h4>
                    <p class="text-sm text-blue-800 dark:text-blue-200">
                      Sweater dan hoodie dirancang dengan potongan yang lebih longgar untuk gaya kasual yang nyaman. Pertimbangkan untuk memilih ukuran yang sesuai untuk lapisan pakaian di bawahnya.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                ...
                <div class="space-y-4">
                  <div class="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 class="text-sm font-medium text-gray-900 dark:text-white">Panjang Sweater</h4>
                      <p class="text-sm text-gray-600 dark:text-gray-400">Ukur dari bahu hingga bagian bawah sweater</p>
                    </div>
                  </div>
                  <div class="flex items-start space-x-3">
                    <div class="flex-shrink-0 w-6 h-6 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center">
                  ...
                  <div class="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-600 dark:text-gray-400">Ukur dari bahu hingga ujung lengan baju</p>
                    </div>
                  </div>
                </div>
              </div>
